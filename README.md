...
`top100.js` 输出前100个 repo 信息，`total.js` 输出所有 repo 信息。 

用到的接口 `https://api.github.com/search/repositories?q=`，详情参考 GitHub API 说明 <https://developer.github.com/v3/search/>

接下来

* 使用 `promise`。
* 优化输出信息，`Author/RepoName` 与 `Link` 合并
...
| starlightme/v2ex-daily-sgin-in | V2EX自动签到脚本 | https://github.com/starlightme/v2ex-daily-sgin-in | 9 | 1 |
...
| fegeek/v2ex-fe-demo | Html/CSS/JS | https://github.com/fegeek/v2ex-fe-demo | 8 | 0 |
